...
SPOTIFY_REDIRECT_URI = "https://charanalyzer.onrender.com/callback"
SPOTIFY_AUTH_URL = "https://accounts.spotify.com/authorize"
SPOTIFY_TOKEN_URL = "https://accounts.spotify.com/api/token"
SPOTIFY_API_URL = "https://api.spotify.com/v1"

# Llama API endpoint and headers
LLAMA_API_URL = "https://runtime.thyris.ai/v1/chat/completions"  
LLAMA_API_KEY = "9b34c4f0-acd7-4e85-a386-835d4ab37b0d"  
...
def analyze_songs():
    ...
    print("Llama API Error:", llama_response.status_code)  # Debugging    
